<%@ Page Title="Employees" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Employees.aspx.cs" Inherits="WebApplication3.Employees" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Employees Details.</h2>
    <h3>Your application Employees page.</h3>
    <p>Use this area to provide additional information about Employess.</p>
    <p>
    ...
    <p>
        ...
        <asp:TextBox ID="TextBox10" runat="server" TabIndex="4"></asp:TextBox>
    </p>
    <p>
        </br>
...
<p>
        <asp:Label ID="Label9" runat="server" Text="Commission Pct"></asp:Label>
        <asp:TextBox ID="textbox11" runat="server" TabIndex="8"></asp:TextBox>
    </p>
    <p>
        </br>
        <asp:Label ID="Label10" runat="server" Text="Manager Id"></asp:Label>
        <asp:TextBox ID="TextBox8" runat="server" TabIndex="9"></asp:TextBox>
    </p>
    <p>
        </br>
        <asp:Label ID="Label11" runat="server" Text="Department ID"></asp:Label>
        <asp:TextBox ID="TextBox9" runat="server" TabIndex="10"></asp:TextBox>
    </p>
    <p>
        &nbsp;</p>
    <p>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource2"  AutoGenerateColumns="False" DataKeyNames="EMPLOYEE_ID" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString4 %>" ProviderName="<%$ ConnectionStrings:ConnectionString4.ProviderName %>" 
